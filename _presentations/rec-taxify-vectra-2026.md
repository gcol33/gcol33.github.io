...
The spark came from rainbowR 2026, the inaugural LGBTQIA+ R conference, which I went to on Lisa's suggestion. The room ran from PhD students to senior researchers, all building free and open-source software, and I left thinking I could do this too. The two packages are released as free software for the same reason. As Richard Stallman, who started the free software movement and wrote the GPL, put it: "To be able to choose between proprietary software packages is to be able to choose your master. Freedom means not having a master."
