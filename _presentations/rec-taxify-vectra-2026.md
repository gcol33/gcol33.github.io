...
This semester our working group decided to start the Research Exchange Club. It gives everyone a regular slot to show the others what they are working on, now that the BioInvasions and Biodiversity Dynamics and Conservation groups are merging and a lot of each side's day-to-day work is easy to miss from the other. I presented taxify and vectra, since they sit close to work both groups run into.
