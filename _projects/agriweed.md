...
This collaboration with AgriWeedClim directly fed into my PhD project [ASAAS](/projects/asaas/) (Alien Species Accumulation Across Scales). The first paper of my thesis built on these analyses to examine how alien species accumulate regionally compared to their representation in local communities. The database provided an essential test case for studying whether increases in alien species at broad scales are mirrored at the level of individual plots, or whether ecological and environmental filters slow their spread.
